...
export class App extends Component {
  ...
  render() {
    return (
      <div>
        <div className="App">
      <img src={Logo} alt="todologo" width="200" height="100" className="logo"/>
      ...
      <div className="container">
        ...
        <button onClick={()=>this.addItem(this.state.newItem)} disabled={!this.state.newItem.length} className="add-btn">Add Todo</button>
      </div>
      ...
      <div className="list">
        <ul>
          ...
          <li>
            <input type="checkbox"/>Record youtube videos
